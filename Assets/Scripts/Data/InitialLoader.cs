...
public class InitialLoader : UnitySingleton<InitialLoader>
{
    ...
    private async void Start()
    {
        ...
        _paragraphs = await _networkManager.GetParagraphs(story, "Alibaba");
        ...
        for (int i = 0; i < textures.Length; i++)
        {
            ...
            var paragraph = i < _paragraphs.Length ? _paragraphs[i] : "";
            LoadAllModelGen(holder, _paragraphs[i], _initialData.storyName, i);
        }
    ...
    private void LoadAllModelGen(GameObject parent, string paragraph, string initialDataStoryName, int i)
    {
