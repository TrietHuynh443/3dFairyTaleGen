...
namespace Oculus.Interaction.Samples.PalmMenu
{
    ...
    public class PalmMenuExampleButtonHandlers : MonoBehaviour
    {
        ...
        public void IncrementElevation(bool up)
        {
            ...
            _targetPosition = new Vector3(_targetPosition.x, Mathf.Clamp(_targetPosition.y + increment, 0f, 5f), _targetPosition.z);
            _elevationText.text = "Page: " + _targetPosition.y.ToString("1.0");
        }
        ...
        public void ToPreviousScene()
        {
            ...
            _elevationText.text = "Page: " + (InitialLoader.CurrentScene + 1).ToString("0.0");
        }
